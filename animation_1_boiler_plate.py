...
pygame.display.set_caption("Yunusun Oyunu") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("esrarengizkasaba.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 14 # code the number of sprite images your sprite sheet has
